...
import SoldeChart from "./soldeChart";

const AccountsWithCharts = ({
  color,
  code,
  title,
  handleChangeCode,
            ...
            return (
              <React.Fragment key={account._id}>
                <div className="p-col-4">
                  <SoldeChart account={account} color={color} />
                </div>
                <div className="p-col-4">
                  <Charts
                    title="Gain"
                    color="#26B413"
                    subcolor="#13B451"
                    tables={account.stats.win}
                    date={account.stats.date}
                  />
                </div>
                <div className="p-col-4">
                  <Charts
...
export default AccountsWithCharts;
